...
pstrlen:
    ...
    movq %rsp, %rbp
    movq $0, %rax # zero to pervent bugs
...
.loop1:
    ...
    # swap
    movq $0, %r11 # zero to pervent bugs
...
.End53:
    ...
    popq %r14 # restore callie save registers
    popq %r13
    popq  %r12
    movq %rbp, %rsp # restore old frame pointer
    popq %rbp
...
.End_loop:
    ...
    popq %r13 # restore callie save registers
    popq %r12
    movq %rbp, %rsp # restore old frame pointer
    popq %rbp
    ret
...
.Loop54:
    ...
    cmpq $0, %rcx
    jle .Equal
    movq $0, %r10 # zero to pervent bugs
